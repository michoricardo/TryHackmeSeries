...
Lo que se hizo fue copiar la /bin/sh shell y llamarla curl, se le dieron permisos correctos y se puso para que se ejecutara en las variables de ambiente, ahora cada vez que se use curl, se estaría ejecutando la shell (/bin/sh)
